...
@section('centurion-title')
	@lang('centurion::forgot_password.page_titles.password_recovery_email_sent')
@endsection
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="text-center">
									...
									<h1><small>@lang('centurion::forgot_password.headings.mail_sent')</small></h1>
									<p>
										@lang('centurion::forgot_password.labels.mail_sent', ['email' => $email])
									</p>
									<div class="row">
