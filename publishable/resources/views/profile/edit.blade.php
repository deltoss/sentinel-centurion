...
@section('centurion-title')
	@lang('centurion::profile.page_titles.update_profile')
@endsection
...
@section('centurion-content')
	...
	@component('centurion::components/errors')
		@slot('title')
			@lang('centurion::profile.headings.update_profile_validation_error')
		@endslot
		@slot('description')
	...
	<form method="POST" action="{{ route('profile.update') }}">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="panel-title">@lang('centurion::profile.headings.update_profile')</div>
			</div>
			<div class="panel-body">
				<fieldset class="form-fieldset">
					<legend>
						<i class="fa-fw fas fa-id-card"></i>
						@lang('centurion::profile.headings.account_information_group')
					</legend>
					<div class='row'>
						<div class='col-sm-4'>
							<div class='form-group'>
								<label for="email">@lang('centurion::profile.labels.email')</label>
				...
				<fieldset class="form-fieldset">
					<legend>
						...
						@lang('centurion::profile.headings.personal_information_group')
					</legend>
					<div class='row'>
						<div class='col-sm-4'>
							<div class='form-group'>
								<label for="first_name">@lang('centurion::profile.labels.first_name')</label>
								<input required type="text" name="first_name" id="first_name" value="{{ old('first_name', $user->first_name) }}" class="form-control" />
							</div>
						</div>
						<div class='col-sm-4'>
							<div class='form-group'>
								<label for="last_name">@lang('centurion::profile.labels.last_name')</label>
